...
from .span import Span, NullSpan, SAMPLED_FLAG, DEBUG_FLAG
...
class Tracer(opentracing.Tracer):
    ...
    def start_span(self,
        ...
        """
        # TODO:
        #1. Check the JSON file for operation names
    ...
    def isValidSpan(self, span):
        return span is None or isinstance(span, NullSpan)
